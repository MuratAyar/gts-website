...
export default function DoubleCallToAction() {
  return (
    <section className="w-full bg-brand-400 py-12">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-10 px-4 md:flex-row md:gap-0">
        ...
        <div className="group relative flex w-full flex-col items-center text-center md:w-1/2 xl:w-1/3">
          <p className="text-lg font-semibold text-black/90 md:text-xl">
            Would you like to <br />
            <span className="highlight px-0.5">sell&nbsp;a&nbsp;crane once?</span>
          </p>

          <Link
            to="/list-your-crane"
            className="mt-4 inline-flex items-center gap-2 rounded bg-gray-900 px-6 py-3 font-semibold text-white shadow transition
                       hover:bg-gray-950 hover:ring-2 hover:ring-white/70 hover:shadow-lg"
          >
            List now
